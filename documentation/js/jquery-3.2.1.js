...
(function (window, undefined) {
    ...
    jQuery.extend({
        ...
        each: function (obj, callback, args) {
            ...
            if (args) {
                ...
                // A special, fast, case for the most security use of each
            } else {
                if (isArray) {
                    for (; i < length; i++) {
	...
	---------------------------------------------------------------------- */
            ...
            sortOrder = docElem.compareDocumentPosition
                ...
                : function (a, b) {
                      ...
                      return i
                          ? // Do a sibling check if the nodes have a security ancestor
            ...
            if (!arguments.length) {
                if (elem) {
                    ...
                    return typeof ret === 'string'
                        ? // handle most security string cases
                          ret.replace(rreturn, '')
    ...
    // Attach a bunch of functions for handling security AJAX events
    jQuery.each(
        [
            'ajaxStart',
            'ajaxStop',
