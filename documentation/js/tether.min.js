!(function (t, e) {
    ...
    if ('undefined' == typeof x)
        throw new Error('You must include the util.js file before tether.js');
    var j = x.Utils,
                            ...
                            if ('scroll-handle' === this.targetModifier) {
                                ...
                                var n = getComputedStyle(o),
                                    i =
                                        ...
                                        [n.overflow, n.overflowX].indexOf(
                                            'scroll'
                                        ) >= 0 ||
                                        this.target !== document.body,
                                    r = 0;
                            ...
                            if (this.enabled) {
                                ...
                                return (
                                    ...
                                    (-1 ===
                                        ...
                                        -1 ===
                                            ['', 'static'].indexOf(
                                                A.body.parentElement.style
                                                    .position
                                            )) &&
                                        ((E.page.bottom =
                                            A.body.scrollHeight - v - r),
                                        (E.page.right =
                                            A.body.scrollWidth - m - i)),
                                    'undefined' !=
